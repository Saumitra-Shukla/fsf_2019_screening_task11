    ...
    if request.method == "POST":
        ...
        if user:
            if user.is_active:
                ...
                return render(request,'baseapp/login.html',context=content_dic)
        else:
...
def update_profile(request):
    if request.method == 'POST':
        ...
        if user_form.is_valid() and profile_form.is_valid():
            ...
            return HttpResponseRedirect('/baseapp/login/')
        else:
...
def profile (request):
    return render(request,'baseapp/profile.html' , {'user' : request.user})
